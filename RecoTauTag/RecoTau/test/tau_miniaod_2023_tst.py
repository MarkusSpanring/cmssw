...
# process = cms.Process("TAURECO",eras.Phase2C2_timing)
...
if runSignal:
    readFiles.extend( [
            'root://cms-xrd-global.cern.ch//store/relval/CMSSW_9_1_1_patch1/RelValZTT_14TeV/MINIAODSIM/91X_upgrade2023_realistic_v1_D17-v1/10000/941011C1-B94A-E711-AD11-0025905B860E.root',
            # 'root://cms-xrd-global.cern.ch//store/relval/CMSSW_9_1_1_patch1/RelValZTT_14TeV/MINIAODSIM/91X_upgrade2023_realistic_v1_D17-v1/10000/B2153CBE-B94A-E711-A7C4-0025905A6122.root',
            ...
            # 'root://cms-xrd-global.cern.ch//store/relval/CMSSW_9_1_1_patch1/RelValZTT_14TeV/MINIAODSIM/PU25ns_91X_upgrade2023_realistic_v1_D17PU200-v1/10000/DEBDB05E-A14C-E711-890D-003048FFD72C.root'
            # 'file:/data/mspanring/TauIDstudies/files/GluGluHToTauTau_M125_14TeV_powheg_pythia8_PU200_91X_upgrade2023_realistic_v3-v3_9E41B688-5F70-E711-9DB7-001E67DFF609.root',
            # 'file:/data/mspanring/TauIDstudies/files/GluGluHToTauTau_M125_14TeV_powheg_pythia8_PU200_91X_upgrade2023_realistic_v3-v3_F68CACA8-1371-E711-8B76-0242AC130002.root',
            # 'file:/data/mspanring/TauIDstudies/files/GluGluHToTauTau_M125_14TeV_powheg_pythia8_PU200_91X_upgrade2023_realistic_v3-v3_F8BF2847-A571-E711-B4F1-0242AC130002.root'
            ] )
else:
    readFiles.extend( [
            'root://cms-xrd-global.cern.ch//store/mc/PhaseIITDRSpring17MiniAOD/QCD_Pt-20toInf_MuEnrichedPt15_TuneCUETP8M1_14TeV_pythia8/MINIAODSIM/PU200_91X_upgrade2023_realistic_v3-v1/00000/36DDB77D-C062-E711-8AAE-00259055C878.root',
            #'root://cms-xrd-global.cern.ch//store/relval/CMSSW_9_1_1_patch1/RelValQCD_Pt-15To7000_Flat_14TeV/MINIAODSIM/PU25ns_91X_upgrade2023_realistic_v1_D17PU200r1-v1/10000/8E5285C2-184E-E711-9B0B-0242AC130004.root'
            ] )
...
#process.GlobalTag.globaltag = cms.string('90X_upgrade2017_TSG_Hcal_V2'),
#process.GlobalTag.globaltag = cms.string('92X_upgrade2017_realistic_v10'),
#process.GlobalTag.globaltag = cms.string('92X_upgrade2023_realistic_v0'),
...
if runSignal:
    process.output.fileName='signal.root'
else:
    process.output.fileName='background.root'
...
execfile('modify_tau_miniaod.py')
